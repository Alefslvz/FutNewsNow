...
window.addEventListener('DOMContentLoaded', function() {
    ...
    if (btnDark) {
        if (localStorage.getItem('darkMode') === 'true') {
            ...
            btnDark.innerHTML = '<span class="icone">☀️</span><span>Modo Claro</span>';
        }

        btnDark.onclick = function() {
            if (document.body.classList.contains('dark-mode')) {
                document.body.classList.remove('dark-mode');
                btnDark.innerHTML = '<span class="icone">🌙</span><span>Modo Escuro</span>';
...
function fazerRegistro() {
    ...
    if (!usuario || !email || !senha) {
        document.getElementById('erroRegistro').innerHTML = '❌ Preencha todos os campos!';
        return;
    }
...
var noticiasIniciais = [{
        ...
        conteudo: "<p>O Flamengo anunciou na noite desta terça-feira (03) que Filipe Luís não é mais o treinador da equipe principal. A decisão foi tomada em comum acordo entre as partes após uma reunião na Gávea.</p><p>O ex-lateral, que assumiu o cargo no início da temporada, deixa o clube após 15 partidas, com 8 vitórias, 4 empates e 3 derrotas.</p><p>Em nota oficial, o Flamengo agradeceu os serviços prestados e deseja sorte na sequência de sua carreira. O clube já iniciou a busca por um novo comandante.</p>"
    },
    {
        id: 2,
        ...
        data: "02/03/2026",
        categoria: "Futebol Brasileiro",
        conteudo: "<p>A decisão do Campeonato Carioca de 2026 já tem data e transmissão confirmadas. Flamengo e Fluminense decidem o título estadual em dois jogos emocionantes.</p><p>O primeiro jogo acontece no próximo sábado, no Maracanã, com transmissão ao vivo para todo o Brasil.</p>"
    },
    {
        id: 3,
        ...
        data: "02/03/2026",
        categoria: "Futebol Brasileiro",
        conteudo: "<p>O Palmeiras venceu o São Paulo por 2 a 1 em um jogo marcado por mais uma polêmica de arbitragem. O Verdão garantiu vaga na próxima fase da competição.</p><p>O lance polêmico aconteceu aos 35 do segundo tempo, quando a arbitragem marcou pênalti contestado pelos são-paulinos.</p>"
    },
    {
        id: 4,
        ...
        conteudo: "<p>Especialistas em arbitragem se reuniram para analisar as decisões contestadas nos últimos clássicos do futebol brasileiro.</p><p>As análises apontam acertos e erros da arbitragem em lances decisivos das últimas rodadas.</p>"
    }
];
